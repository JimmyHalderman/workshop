...
#1 
Stevens et al. describe a “Random Forests Algorithm” method in their paper and it’s applications, advantages and dis-advantages in predicating populations and population growth. The model uses rasterized covariates of  land cover types, topography and other satellite imagery, to predict at a more accurate level, the populations living in those areas. Instead of relying on census data, the random forest model allows for a more systematized and falsifiable method for mapping populations. Covariates and predictive weightings can be changed and cross referenced to find a best fit approach and test for accuracy.
